...
// .wrangler/tmp/bundle-4YD2rt/checked-fetch.js
      ...
      if (requestType === "custom") {
        if (customConfigStr) {
          try {
            ...
            console.log(`[Debug] Using CUSTOM configuration passed in request with ${extractionRules.length} rules.`);
          } catch (e) {
          ...
          console.error('[Debug] Type is "custom" but no "config" parameter provided.');
          return new Response('Type is "custom" but missing "config" query parameter.', { status: 400 });
        }
      } else {
...
// .wrangler/tmp/bundle-4YD2rt/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4YD2rt/middleware-loader.entry.ts
